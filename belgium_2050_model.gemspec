...
Gem::Specification.new do |s|
  s.name = "belgium_2050_model"
  s.required_ruby_version = ">1.9.1"
  s.version = version
  s.add_dependency('ffi','>= 1.0.11')
  s.add_development_dependency('excel_to_code')
  s.author = "Thomas Counsell, UK Department of Energy and Climate Change"
  s.email = "tom.counsell@decc.gsi.gov.uk"
  s.homepage = "http://github.com/decc/belgium_2050_model"
  s.platform = Gem::Platform::RUBY
  s.summary = "A C version of the Belgium 2050 Pathway Excel Spreadsheet"
