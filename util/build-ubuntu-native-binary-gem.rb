...
# the master branch of http://github.com/belgium/belgium_2050_model.git 

branch = ARGV[0] || "master"
server_name = ARGV[1] || "belgium_2050_model_gem_build_#{branch}"
...
## THE CODE
git clone http://github.com/decc/belgium_2050_model.git
...
# Compile and build
pwd
cd /home/ubuntu/belgium_2050_model
pwd
git checkout #{branch}
bundle
cd ext
rake
cd ..
gem build belgium_2050_model.gemspec.binary
EOT
